...
public class CustomProgressBar {
	...
	public CustomProgressBar(double width, double height, float margin, String stepURL, Font customFont) 
	{
		...
		progressBar.setStyle("-fx-background-image:url('/resources/Back.png');");
